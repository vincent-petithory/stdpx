	...
	<xsl:template match="/">
		...
		<xsl:element name="html">
			...
			<body class="classFrameContent">
				<h3><a href="package-summary.html" onclick="javascript:loadClassListFrame('all-classes.html');">Packages</a></h3>
				...
				<xsl:if test="$config/languageElements[@show='true']">
					<h3><a href="language-elements.html">Language Elements</a></h3>
					<table cellpadding="0" cellspacing="0">
...
<!-- 					<xsl:if test="$config/options[@showDeprecated='true']"> -->
				<xsl:if test="$config/appendixes[@show='true']">
					<h3><a href="appendixes.html">Appendixes</a></h3>
					<table cellpadding="0" cellspacing="0">
